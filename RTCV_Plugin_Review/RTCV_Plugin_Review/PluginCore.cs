...
namespace PLUGIN_REVIEW
{
    ...
    public class PLUGIN_REVIEW : IPlugin, IDisposable
    {
        //-------[ Plugin metadata ]-------

        // >>> Make sure you rename BOTH the namespace and class (Very important)
        public string Description => "Plugin to showcase information for review";
        public string Author => "Mistsofnowh3r3";
        ...
        public string Name => nameof(PLUGIN_REVIEW).Replace("_"," ");
        ...
        public bool Stop()
        {
            if (PLUGIN_REVIEW.CurrentSide == RTCSide.Client && !S.ISNULL<PluginForm>() && !S.GET<PluginForm>().IsDisposed)
            {
